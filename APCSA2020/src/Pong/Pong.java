...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		...
		ball = new Ball(100,100,20,20,Color.BLACK,1,1);
		
		//ball = new BlinkyBall(100,100,20,20,Color.BLACK,1,1);
		
		//ball = new InvisibleBall(100,100,20,20,Color.BLACK,1,1);
		
		//ball = new SpeedUpBall(100,100,20,20,Color.BLACK,1,1);
		
		leftPaddle = new Paddle(20,10,20,100,Color.RED,4);
		
		rightPaddle = new Paddle(770,10,20,100,Color.RED,4);
		
		leftWall = new Wall(10,0,10 , 800, Color.white);
		rightWall = new Wall(790, 0, 10, 800, Color.white);
		
		topWall = new Wall(0,0,800,10, Color.black);
		bottomWall = new Wall(0,460,800,10, Color.black);
   ...
   public void paint(Graphics window)
   {
		 ...
		 * 
		 * ball.setYSpeed( ball.getYSpeed() * -1); } else {
		 * ball.setXSpeed(ball.getXSpeed() * -1); } }
		 * 
		 * //see if the ball hits the right paddle
		 * 
		 * if ( ( ball.getX() >= rightPaddle.getX() - .25 * rightPaddle.getWidth() -
		 * Math.abs(ball.getXSpeed()) ) && (ball.getY() >= rightPaddle.getY() &&
